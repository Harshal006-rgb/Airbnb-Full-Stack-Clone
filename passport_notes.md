...
### 2. `isOwner` / `isAuthorized` (Authorization Check)
Verifies if the logged-in user is the actual creator/owner of a specific resource (e.g., a Listing or Review) before allowing modifications.
```javascript
// middleware.js
